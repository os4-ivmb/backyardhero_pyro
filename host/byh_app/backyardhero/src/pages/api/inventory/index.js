...
export default function handler(req, res) {
  if (req.method === 'POST') {
    ...
    try {
      const result = inventoryQueries.insert.run(name, type, duration, fuse_delay, lift_delay, burn_rate, color, available_ct, youtube_link, youtube_link_start_sec, image);
