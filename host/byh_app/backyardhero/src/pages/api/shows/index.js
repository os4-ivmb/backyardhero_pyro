...
export default function handler(req, res) {
  if (req.method === 'POST') {
    ...
    try {
      ...
      const result = showQueries.insert.run(name, duration, version, runtime_version, display_payload, runtime_payload, authorization_code, protocol, audio_file, receiver_locations);
